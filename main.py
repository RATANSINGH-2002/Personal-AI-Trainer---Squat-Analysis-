...
import cv2
import numpy as np
from Functions import find_angle, get_landmark_features, draw_text, draw_dotted_line
...
# Create a real-time video recording 
...
while cap.isOpened():
    ...
    cv2.resizeWindow('Processed Frame', 1500, 800)  # Set the desired width and height
